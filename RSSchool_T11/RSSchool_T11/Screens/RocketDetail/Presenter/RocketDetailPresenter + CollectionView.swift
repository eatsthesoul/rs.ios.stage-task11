...
extension RocketDetailPresenter: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: RocketDetailViewCell.Constants.reuseIdentifier,
                                                      for: indexPath)

        if let cell = cell as? RocketDetailViewCell {
